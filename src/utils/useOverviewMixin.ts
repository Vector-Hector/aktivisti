...
export default function <ItemsDto extends ItemDto, ItemFilterParams>(
  store: OverviewStore<ItemsDto, ItemFilterParams>,
  list_request: ApiRoute<ItemsDto>
) {
  ...
  async function updateFilterParams(params: ItemFilterParams) {
    ...
    const { data: new_items, pagination: new_pagination } = (
